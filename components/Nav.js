  ...
  return (
    <nav className={className}>
      <div className="flex justify-center md:hidden -mx-6 mt-4 mb-6 pb-4 border-b">
        <a className="flex items-center text-gray-500 hover:text-gray-700 mr-5" href="https://github.com/inertiajs">
        ...
        <a className="flex items-center text-gray-500 hover:text-gray-700 mr-5" href="https://twitter.com/inertiajs">
          <svg className="fill-current w-5 h-5" viewBox="0 0 20 20">
            <title>Twitter</title>
      ...
      <div className="mt-8 md:mt-12 mb-3 text-xs font-bold uppercase text-gray-500 tracking-widest">
        Getting started
      </div>
      <ul>
        <li className="md:pr-3">
